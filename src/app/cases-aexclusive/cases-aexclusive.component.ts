...
@Component({
  selector: 'app-cases-aexclusive',
  imports: [],
  templateUrl: './cases-aexclusive.component.html',
  styleUrl: './cases-aexclusive.component.scss'
})
export class CasesAExclusiveComponent implements AfterViewInit {

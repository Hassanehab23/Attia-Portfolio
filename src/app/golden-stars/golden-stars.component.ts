...
@Component({
  selector: 'app-golden-stars',
  imports: [],
  templateUrl: './golden-stars.component.html',
  styleUrl: './golden-stars.component.scss'
})
export class GoldenStarsComponent implements AfterViewInit {
